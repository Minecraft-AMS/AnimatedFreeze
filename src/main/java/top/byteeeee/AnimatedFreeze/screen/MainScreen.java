...
public class MainScreen extends Screen {
    ...
    protected void init() {
        ...
        addButton = new ButtonWidget(
            this.width / 2 + 60, this.height / 2 - 10, 20, 20,
            Messenger.s("+").formatted(Formatting.GREEN),button -> {
        ...
        removeButton = new ButtonWidget(
            this.width / 2 + 90, this.height / 2 - 10, 20, 20,
        ...
        viewListButton = new ButtonWidget(
            this.width / 2 - 40, this.height / 2 + 20, 80, 20,
            Messenger.s(Messenger.tr("animatedFreeze.ui.viewList").getString()), button -> {
            if (this.client != null) {
                this.client.openScreen(new ListScreen(this));
            }
        });
        this.addButton(viewListButton);
    }
